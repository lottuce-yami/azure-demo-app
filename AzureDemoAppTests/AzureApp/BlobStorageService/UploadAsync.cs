...
public class UploadAsync
{
    ...
    public async Task UploadsBlobWithMetadata()
    {
        ...
        var service = new AzureDemoApp.Services.BlobStorageService(configuration);
        ...
        var blobName = AzureDemoApp.Services.BlobStorageService.SanitizeFileName(form.File.Name);
